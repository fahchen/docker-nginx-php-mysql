...
class Index extends Controller {
    ...
    public function to_work_push(){
        $url = 'https://beta.skylarkly.com/api/v4/pushes/wechat';//接收地址
                ...
                if (!empty($user['openid'])){
                    $data = [
                        ...
                        'news_entity'=>(object)[
                            ...
                            "picurl"=>"http://pajwyszsz.bkt.clouddn.com/92961ddc405ba5e592d350d95445fa59.jpeg"],
                    ...
                    $header = array('Authorization:3d06df76b958483cb6e36d59acfde7ef12a0b3a24587cc1476a776158145043d:eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lc3BhY2VfaWQiOjF9.sBNW1M4e1SMYVq4oJhS6qu3rkk7FgzBgkryVK-L5dXA');//定义content-type为xml
...
//        var_dump($openids);exit;
    ...
    public function getOauth(){
        $code = $_GET['code'];
//        var_dump($code);exit;
        $url = 'http://117.48.200.115:8080/api/token';//接收地址
...
//        $header ["Content-type"]= "application/x-www-form-urlencoded";
        ...
        curl_setopt($ch, CURLOPT_POST, true);//设置为POST方式
        curl_setopt($ch, CURLOPT_POSTFIELDS, 'grant_type=authorization_code&client_id=app05028472-bc11-4b8f-bd37-b2613fdc1cc9&client_secret=c56d0e9a7ccec67b4ea131655038d604&code='.$code.'&redirect_uri=http://kaoqin.webuildus.com/admin/index/getOauth');//POST数据
//        var_dump($ch);exit;
        $response = curl_exec($ch);//接收返回信息
        if(curl_errno($ch)){//出错则显示错误信息
            print curl_error($ch);
...
//        echo $token;exit;
        //获取用户信息
        $url = 'http://117.48.200.115:8080/api/userDetail?access_token='.$token;//接收地址
